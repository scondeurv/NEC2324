...
public class MyNeuralNetworkTests
{
    ...
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, }, 300, 1000, 0.1, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 7, 1 }, new[] { Linear, Linear, Linear, }, 300, 1000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 1 }, new[] { Linear, Linear, Linear, }, 300, 1000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 23, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, Linear }, 300, 10000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 7, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, Linear }, 300, 10000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, }, 100, 1000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, }, 900, 1000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, }, 300, 1000, 0.2, 0.1, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, }, 300, 1000, 0.2, 0.00001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, }, 300, 1000, 0.2, 0.0001, 0, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Linear, Linear, Linear, Linear, }, 300, 1000, 0.2, 0.0001, 0.4, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Sigmoid, Sigmoid, Sigmoid, Sigmoid }, 300, 1000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { Tanh, Tanh, Tanh, Tanh }, 300, 1000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
    [InlineAutoData(new[] { 9, 15, 7, 1 }, new[] { ReLu, ReLu, ReLu, ReLu }, 300, 1000, 0.2, 0.0001, 0.6, "A1-synthetic.training.txt", "A1-synthetic.test.txt")]
